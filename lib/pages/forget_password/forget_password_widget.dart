                            ...
                            child: Column(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      '8j9zrydx' /* E-posta adresinizi girin, size... */,
                                    ),
                                    textAlign: TextAlign.center,
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                      ...
                                      Padding(
                                        ...
                                        child: FFButtonWidget(
                                          ...
                                          text: FFLocalizations.of(context)
                                              .getText(
                                            'ep51fbee' /* Sıfırlama Bağlantısı Gönder */,
                                          ),
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'mygwsnem' /* Şifrenizi hatırladınız mı? */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'bda96ii0' /* Hesabınıza erişim konusunda so... */,
                              ),
                              textAlign: TextAlign.center,
                              style: FlutterFlowTheme.of(context)
                                  .bodySmall
                          ...
                          Text(
                            FFLocalizations.of(context).getText(
                              '76s0v34r' /* Destek ile İletişime Geçin */,
                            ),
                            textAlign: TextAlign.center,
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  ...
                                  color: FlutterFlowTheme.of(context).gradyan3,
                                  letterSpacing: 0.0,
                                  fontWeight: FontWeight.w500,
                                  fontStyle: FlutterFlowTheme.of(context)
                                      .bodyMedium
