...
class _AnasayfaWidgetState extends State<AnasayfaWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (!FFAppState().seenWalkthrough) {
        safeSetState(
            () => _model.butonController = createPageWalkthrough(context));
        _model.butonController?.show(context: context);
      }
      FFAppState().seenWalkthrough = true;
      safeSetState(() {});
    });
...
HOŞGELDİNİZ */
                          ...
                          Column(
                            ...
                            children: [
                              Text(
                                FFLocalizations.of(context).getText(
                                  'a427o43v' /* Bir meyve fotoğrafı yükle, ger... */,
                                ),
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      FFLocalizations.of(context).getText(
                                        'ivpro8y1' /* Galerinizden bir fotoğraf seçi... */,
                                      ),
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .titleMedium
                                      ...
                                      onPressed: () async {
                                        ...
                                        if (selectedMedia != null &&
                                          ...
                                          try {
                                            ...
                                            _model.isDataUploading_uploadDataTtr =
                                                false;
                                          }
                                          if (selectedUploadedFiles.length ==
                                              selectedMedia.length) {
                                            safeSetState(() {
                                              _model.uploadedLocalFile_uploadDataTtr =
                                        ...
                                        safeSetState(() {});
                                        await actions.analyzeFruitsVegetables(
                                          _model
                                              .uploadedLocalFile_uploadDataTtr,
                                          'https://1fcbcd648440.ngrok-free.app',
                                        );
                                        await SQLiteManager.instance.addPhoto(
  ...
  TutorialCoachMark createPageWalkthrough(BuildContext context) =>
      TutorialCoachMark(
        ...
        onFinish: () async {
          safeSetState(() => _model.butonController = null);
        },
        onSkip: () {
          return true;
        },
